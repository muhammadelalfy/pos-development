                            ...
                            <tbody>
                                ...
                                @foreach ($users as $key => $user)
                                    <tr>
                                        ...
                                        <td>
                                            &emsp;
                                            <a href="{{route('admins.edit',$user->id)}}" class="edit-project-sidebar"> <i class="fas fa-edit" style="color: #111"></i></a>
                                            &emsp;
                                            <a href="{{ route('admins.delete', $user->id) }}"><i class="far fa-trash-alt" style="color: #f00"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
