...
@section('content')
    ...
    <div class="container">
        <button  style="floating:right" class="btn btn-primary hidden-print" onclick="window.print();"><span class="bi bi-printer" aria-hidden="true"></span>
            Print</button>
           ...
           <div class="check__body">
            <div class="check_header">
                ...
                <div class="check_title" style="text-align: center;">
                     <h4>اشعار دائن للفاتورة الضربية المبسطه</h4>
                </div>
                
                <div style="margin-left: -142px;">
                     <h4 style="display: ruby-base;">  رقم الاشعار : {{$Ordersdata -> bou_number}}</h4>
                     <h5>{{ $date2 }}</h5>
                  <h5>{{ $time2 }}</h5>
                </div>
