  ...
  #printPageButton {
    ...
    <div class="title">
        ...
        <div class="container">
            ...
            <h3 class="ar"> اشعار دائن فاتورة ضريبية</h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="num-invoice-content mb-4">
                            ...
                            <div class="number">
                                   <input type="text" value="{{$purshase->bou_number}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="num-invoice-content mb-4">
                            ...
                            <div class="number">
                                   <input type="text" value="{{$purshase->updated_at}}" readonly>
                            </div>
                        </div>
